...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        ...
        http
                ...
                .and()
                .csrf().csrfTokenRepository(repo).ignoringAntMatchers("/css/**", "/img/**")
                .sessionAuthenticationStrategy(new MyCsrfSessionAuthenticationStrategy(repo))
                .and()
                .requiresChannel().anyRequest().requiresSecure()
                .and()
                .authorizeRequests()
                .antMatchers("/login**", "/login?error=true", "/register*", "/css/**", "/img/**", "/favicon.ico").permitAll()
                ...
                .logout()
                .logoutUrl("/logout")
                .deleteCookies(SecurityConstants.COOKIE_NAME, "JSESSIONID", "XSRF-TOKEN")
                .and()
